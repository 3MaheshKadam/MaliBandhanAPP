...
//   const tabs = useMemo(
//     () => [
//       { id: 'all', label: 'All Matches', count: matches.filter((m) => m.compatibility > 0).length, icon: UsersIcon },
...
//                 </Pressable>
//               ) : match.interestSent ? (
//                 <Pressable disabled style={styles.sentPill}>
...
//           <Text style={styles.loadingSubtitle}>Curating the best profiles for you</Text>
//         </View>
//       ) : (
//         <>
...
//             Try adjusting your preferences or check back soon for new profiles!
//           </Text>
...
//                 <Text style={styles.noFullImageText}>No Profile Photo Available</Text>
//               </View>
//             )}
//           </View>
//         </Modal>
...
//             <Text style={styles.headerSubtitle}>{filteredMatches.length} profiles found</Text>
//           </View>
...
//               >
//                 <Icon size={16} color={isActive ? Colors.white : Colors.primary} />
...
//             {sortBy === 'compatibility' ? 'Best Match' :
...
//           ListHeaderComponent={<View style={{ height: showQuickFilters ? 60 : 8 }} />}
//         />
//       ) : (
